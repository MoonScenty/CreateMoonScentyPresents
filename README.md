...
**아연은 약한 불로 녹는다.** 실제로 420°C이고, 그래야 이 시대가 성립한다 — 블레이즈 버너를 요구하면 네더가 아연 앞에 서고, 아연이 없으면 관문 1이 막힌다. 더 높은 온도를 요구하는 금속은 뒷 시대의 몫이다.
...
| 숯가마 | 원목 → 숯. 연료가 필요 없다 | 아래에 불 + **위에 덮개** |
...
| 파운드리 믹서 | `foundry_mixer` | 합금. **다음 시대** | 기계식 혼합기 + 내화벽돌 ×2 |
