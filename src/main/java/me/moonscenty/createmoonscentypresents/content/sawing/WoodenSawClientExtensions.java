...
/**
 * A back and forth stroke for the saw, drawn in place of the vanilla use animation.
 * <p>
 ...
 */
public class WoodenSawClientExtensions implements IClientItemExtensions {

    /** Ticks for one full push-pull. Shorter than vanilla's brush for a busier cut. */
    private static final float STROKE_TICKS = 8.0F;
    /** How far the saw travels along the cut, in blocks. */
    private static final float STROKE_REACH = 0.14F;
    /** Degrees the blade rocks through the stroke. */
    private static final float STROKE_ROCK = 6.0F;
    ...
    public boolean applyForgeHandTransform(PoseStack pose, LocalPlayer player, HumanoidArm arm, ItemStack stack,
        ...
        // nothing here re-orients the saw; it only moves it.
        ...
        // A slight rock so the blade looks like it is biting rather than sliding.
